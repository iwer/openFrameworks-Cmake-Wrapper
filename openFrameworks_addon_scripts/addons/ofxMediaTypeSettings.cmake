...
SET(ADDON_SRC ${ADDON_SRC} ${ADDON_ROOT}/libs/ofxMediaType/src/MediaTypeMap.cpp)

#########################################################################


set(ADDONS_SOURCES ${ADDONS_SOURCES} ${ADDON_SRC})
set(ADDONS_INCLUDE_DIRS ${ADDONS_INCLUDE_DIRS} "${ADDON_ROOT}/src/" "${ADDON_ROOT}/libs/ofxMediaType/include/")
