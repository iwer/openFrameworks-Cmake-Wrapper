...
SET(ADDON_SRC 
	${ADDON_ROOT}/src/ofxAssimpAnimation.cpp
	${ADDON_ROOT}/src/ofxAssimpMeshHelper.cpp
	${ADDON_ROOT}/src/ofxAssimpModelLoader.cpp
	${ADDON_ROOT}/src/ofxAssimpTexture.cpp
	)
...
set(ADDONS_LIBRARIES ${ADDONS_LIBRARIES} assimp)
