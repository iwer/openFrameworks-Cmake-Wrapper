...
file( GLOB_RECURSE ADDON_LIB_SRC ${ADDON_ROOT}/libs/*.cpp)
set(ADDON_SRC 
    ${ADDON_ROOT}/src/ofxXmlSettings.cpp
    ${ADDON_ROOT}/libs/tinyxml.cpp
    ${ADDON_ROOT}/libs/tinyxmlerror.cpp
    ${ADDON_ROOT}/libs/tinyxmlparser.cpp
    )
set(ADDON_HDR
    tinyxml.h
    ofxXmlSettings.h)
