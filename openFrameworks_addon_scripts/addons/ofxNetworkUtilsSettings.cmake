...
set (ADDON_SRC 
	${ADDON_SRC}
	"${ADDON_ROOT}/libs/ofxNetworkUtils/src/IPAddressRange.cpp"
	"${ADDON_ROOT}/libs/ofxNetworkUtils/src/NetworkInterfaceListener.cpp"
	"${ADDON_ROOT}/libs/ofxNetworkUtils/src/NetworkUtils.cpp")
#########################################################################
...
set(ADDONS_INCLUDE_DIRS 
	${ADDONS_INCLUDE_DIRS} 
	"${ADDON_ROOT}/src/"
	"${ADDON_ROOT}/libs/ofxNetworkUtils/include/")
